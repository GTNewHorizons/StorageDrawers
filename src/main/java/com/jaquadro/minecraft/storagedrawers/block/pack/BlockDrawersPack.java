...
public class BlockDrawersPack extends BlockDrawers implements IPackBlock {
    ...
    private BlockDrawers getSimilarBlock() {
        if (drawerCount == 1 && !halfDepth) return ModBlocks.fullDrawers1;
        if (drawerCount == 2 && !halfDepth) return ModBlocks.fullDrawers2;
        if (drawerCount == 4 && !halfDepth) return ModBlocks.fullDrawers4;
        if (drawerCount == 2 && halfDepth) return ModBlocks.halfDrawers2;
        if (drawerCount == 4 && halfDepth) return ModBlocks.halfDrawers4;
