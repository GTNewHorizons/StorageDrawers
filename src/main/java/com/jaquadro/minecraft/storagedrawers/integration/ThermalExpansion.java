...
public class ThermalExpansion extends IntegrationModule {
    ...
    public void init() throws Throwable {
        ...
        Item itemMaterial = GameData.getItemRegistry()
            .getObject(MOD_ID + ":material");
        ...
        itemMaterial = GameData.getItemRegistry()
            .getObject("ThermalFoundation:material");
        ...
        if (StorageDrawers.config.cache.enableStorageUpgrades) {
            mtPulverizerAddRecipe.invoke(
                ...
                new ItemStack(itemMaterial, 2, 0),
                itemSawdust,
                100);
            mtPulverizerAddRecipe.invoke(
                null,
                ...
                new ItemStack(itemMaterial, 2, 1),
                itemSawdust,
                100);
            mtPulverizerAddRecipe.invoke(
                null,
