...
public class ConfigManager {
    ...
    public class ConfigSection {
        ...
        public ConfigCategory getCategory() {
            ...
            if (parent != null) category = config.getCategory(
                parent.getCategory()
                    .getQualifiedName() + "."
                    + name.toLowerCase());
    ...
    public void syncConfig() {
        ...
        cache.enableQuantifyUpgrades = config.get(Configuration.CATEGORY_GENERAL, "enableQuantifyUpgrades", true)
            .setLanguageKey(LANG_PREFIX + "prop.enableQuantifyUpgrades")
            .setRequiresMcRestart(true)
            .getBoolean();
        ...
        cache.enableBackhandIntegration = config.get(sectionIntegration.getQualifiedName(), "enableBackhand", true)
            .setLanguageKey(LANG_PREFIX + "integration.enableBackhand")
            .setRequiresMcRestart(true)
            .getBoolean();
        ...
        cache.level7Mult = config.get(sectionUpgrades.getQualifiedName(), "level7Mult", 21)
            .setLanguageKey(LANG_PREFIX + "upgrades.level7Mult")
            .setRequiresWorldRestart(true)
            .getInt();
        cache.level8Mult = config.get(sectionUpgrades.getQualifiedName(), "level8Mult", 34)
            .setLanguageKey(LANG_PREFIX + "upgrades.level8Mult")
            .setRequiresWorldRestart(true)
            .getInt();
