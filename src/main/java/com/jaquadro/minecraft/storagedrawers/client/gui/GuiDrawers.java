...
public class GuiDrawers extends GuiContainer {
    ...
    private static final ResourceLocation guiTextures1 = new ResourceLocation(
        "storagedrawers",
        "textures/gui/drawers_1.png");
    private static final ResourceLocation guiTextures2 = new ResourceLocation(
        "storagedrawers",
        "textures/gui/drawers_2.png");
    private static final ResourceLocation guiTextures4 = new ResourceLocation(
        "storagedrawers",
        "textures/gui/drawers_4.png");
    private static final ResourceLocation guiTexturesComp = new ResourceLocation(
        "storagedrawers",
        "textures/gui/drawers_comp.png");
    ...
    protected void drawGuiContainerForegroundLayer(int p_146979_1_, int p_146979_2_) {
        String name = tileDrawers.hasCustomInventoryName() ? tileDrawers.getInventoryName()
            : I18n.format(tileDrawers.getInventoryName(), empty);
    ...
    protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
        ...
        if (tileDrawers.getDrawerCount() == 1) mc.getTextureManager()
            .bindTexture(guiTextures1);
        else if (tileDrawers.getDrawerCount() == 2) mc.getTextureManager()
            .bindTexture(guiTextures2);
        else if (tileDrawers.getDrawerCount() == 4) mc.getTextureManager()
            .bindTexture(guiTextures4);
        else mc.getTextureManager()
            .bindTexture(guiTexturesComp);
        ...
        if (inventorySlots instanceof ContainerDrawers) {
            ...
            for (int i = 0, n = storageSlots.size(); i < n; i++) {
                ...
                drawTexturedModalRect(
                    guiX + slot.xDisplayPosition,
                    guiY + slot.yDisplayPosition,
                    smDisabledX,
                    smDisabledY,
                    16,
                    16);
        ...
        if (inventorySlots instanceof ContainerDrawers) {
            ...
            for (int i = 0, n = upgradeSlots.size(); i < n; i++) {
                ...
                if (slot instanceof SlotUpgrade && !((SlotUpgrade) slot).canTakeStack()
                    ...
                    && slot.yDisplayPosition == y) return false;
            }
        }
    ...
    private RenderItem setItemRender(RenderItem renderItem) {
        if (IntegrationRegistry.instance()
            .isModLoaded("NotEnoughItems")) return NotEnoughItems.setItemRender(renderItem);
        else {
